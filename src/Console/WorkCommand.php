...
namespace GarretGunter\DoctrineQueue\Console;
 ...
 * Class WorkCommand
 *
 * @package GarretGunter\DoctrineQueue\Console
 */
class WorkCommand extends IlluminateWorkCommand
{
	private const SIGNATURE_REGEX_PATTERN = '/([\w:-]+)(?=\s|\{)/i';
	 ...
	 * @parma array $config
	 */
	public function __construct(Worker $worker, Repository $cache, array $config)
	{
